            ...
            <div class="panel-body">
                <form action="{Text::url('login/post')}" method="post">
                    ...
                    <div class="form-group">
                        <label>
                            {if isset($_c['registration_username']) && $_c['registration_username'] == 'phone'}
                                {Lang::T('Phone Number')}
                            {elseif isset($_c['registration_username']) && $_c['registration_username'] == 'email'}
                                {Lang::T('Email')}
                            {else}
                                {Lang::T('Usernames')}
                            {/if}
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="username"
                                placeholder="{if (isset($_c['country_code_phone']) && $_c['country_code_phone']!= '') || (isset($_c['registration_username']) && $_c['registration_username'] == 'phone')}{if isset($_c['country_code_phone'])}{$_c['country_code_phone']}{/if} {Lang::T('Phone Number')}{elseif isset($_c['registration_username']) && $_c['registration_username'] == 'email'}{Lang::T('Email')}{else}{Lang::T('Usernames')}{/if}">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="btn-group btn-group-justified mb15">
                        {if !isset($_c['disable_registration']) || $_c['disable_registration'] != 'noreg'}
                            <div class="btn-group">
